...
if(empty($rutOperario) || empty($contraseniaOperario)) {
    ...
    // CREAMOS LA CONSULTA
    $sql = "SELECT operarios.id,operarios.nombreOperario,operarios.rutOperario,operarios.correoOperario,operarios.contraseniaOperario,operarios.tipoOperario,operarios.contraseniaOperarioFTP,operarios.telefonoOperario,operarios.rutOperarioFTP,empresas.rutEmpresa FROM operarios JOIN empresas ON empresas.id=operarios.empresa_id WHERE operarios.rutOperario='$rutOperario'";
